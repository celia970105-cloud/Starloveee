            ...
            <form onSubmit={saveTextConfigs} className="space-y-4">
              {savedTextSuccess && (
                <div className="p-3 bg-emerald-500/10 border border-emerald-500/20 text-emerald-200 text-xs rounded-xl flex items-center gap-2">
                  ...
                  <span>網站宣告與主視覺文字更新成功！首頁已同步重寫。</span>
                </div>
              )}
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-[#FF799C] to-[#9933ff] hover:opacity-90 text-white font-medium text-sm py-3 rounded-xl shadow-lg transition-all active:scale-95"
              >
                立刻套用網站宣告配置
              </button>
            </form>
