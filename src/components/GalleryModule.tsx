...
export default function GalleryModule({ currentUser, onRefreshData }: GalleryModuleProps) {
  ...
  const categories = ["All", "Concert", "Fanart", "Behind the Scenes", "General"];
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!title || !imageUrl) {
      setSubmitError("請填寫所有必填欄位 (標題、相片網址)！");
      return;
    }
            ...
            >
              ...
              {submitSuccess ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-4 text-left">
                  ...
                  <div>
                    <label className="block text-xs font-mono text-[#6E4B55]/70 mb-1.5">相片網址 *</label>
                    <input
                      type="url"
                      required
                    ...
                    />
                    <span className="text-[10px] text-[#6E4B55]/50 mt-1 block">提示：請填寫公開可存取的圖片網址 (Unsplash 等)。</span>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="Fanart" className="text-[#6E4B55]">同人同好繪</option>
