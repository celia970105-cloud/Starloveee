                ...
                <div>
                  ...
                  {showAlbumForAvatar ? (
                    ...
                    <div className="flex items-center gap-3">
                      <div className="h-11 w-11 rounded-full overflow-hidden border-2 border-[#FF799C] shrink-0 bg-white">
            ...
            <div className="md:col-span-5 space-y-6">
              ...
              <div className="relative h-28 rounded-2xl overflow-hidden border border-[#FF799C]/20 bg-[#FFF6F2]">
                ...
                <div className="absolute bottom-3 left-4 flex items-center gap-3">
                  <div className="h-12 w-12 rounded-full overflow-hidden border border-[#FF799C]/60 bg-white">
